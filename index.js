...
const marcRecordsTwo =
  "01528cam a2200361 i 20191204222522.5t|920107s1992    nyua     b    000 1 eng    a   92002605 //r942  a0020198817 :c$9.00 ($11.50 in Can.)  a0020198825 :c$6.00 ($7.95 Can.)  aDLCcDLCdWiMaMIbengerda  an-us---00aPS3511.I9bG7 1992b00a813/.522201 aFitzgerald, F. Scottq(Francis Scott),d1896-1940,eauthor.4aut14aThe great Gatsby /cF. Scott Fitzgerald ; preface and notes by Matthew J. Bruccoli.  aFirst Collier Books edition. 1aNew York ;aNew York ;aToronto :bCollier Books,c1992. 1a[Place of publication not identified] :bMaxwell Macmillan Canada 1a[Place of publication not identified] :bMaxwell Macmillan International  axvi, 216 pages :billustrations ;c21 cm.  atextbtxt2rdacontent  aunmediatedbn2rdamedia  avolumebnc2rdacarrier0 aA Scribner classic  aIncludes bibliographical references (p. 215-216)  aFollows the adventures of Jay Gatsby as he tries to win back the woman he loved and lost.0 aAccelerated ReaderbUGc7.3d8.0z708 0aMan-woman relationshipszNew York (State)zLong IslandvFiction. 0aUpper classzNew York (State)zLong IslandvFiction. 0aLong Island (N.Y.)vFiction. 7aLove stories.2gsafd";
const app = express();
...
app.get("/", (req, res) => {
  res.send(convertRecords(marcRecordsTwo));
});
